...
<body>
    ...
    <div class="container logo">
        <img src="assets/logoteste.png" alt="Logo">
    </div>

    <!-- Imagem de Valores -->
    <div class="container imagem-valores">
        <img src="assets/valoresteste.png" alt="Valores">
    </div>
...
<body>
    ...
    <div id="professionals-container" class="hidden">
        ...
        <div class="button-container">
            <button type="button" id="barbeiro-btn" class="btn btn-primary">NOME DO BARBEIRO</button>
        </div>
    ...
    function showProfissionals() {
        ...
        document.getElementById('barbeiro-btn').style.display = 'block';
    }

    document.getElementById('barbeiro-btn').addEventListener('click', function () {
        fetchHours('NOME DO BARBEIRO');
    });
...
function generateHourButtons(person, unavailableHours) {
    ...
    <div class="container imagem-adicional">
        <img src="assets/planosteste.png" alt="Imagem Adicional">
    </div>
