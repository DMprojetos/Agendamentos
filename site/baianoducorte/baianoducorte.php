...
<body>
    ...
    <div class="container logo">
        <img src="assets/logobaiano.png" alt="Logo">
    </div>
...
<body>
    ...
    <div id="professionals-container" class="hidden">
        ...
        <div class="button-container">
            ...
            <button type="button" id="guilherme-btn" class="btn btn-primary">Guilherme</button>
        </div>
    ...
    document.getElementById('prosseguir-btn').addEventListener('click', function () {
        ...
        if (inputNome && inputTelefone) {
            ...
            for (let i = 0; i < 7; i++) {
                ...
                // Exibir apenas dias de terça (2) a sábado (6)
                if (nextDate.getDay() < 2 || nextDate.getDay() > 6) continue;
    ...
    function showProfissionals() {
        ...
        document.getElementById('baiano-btn').style.display = 'block';
        document.getElementById('gabriel-btn').style.display = 'block';
        document.getElementById('guilherme-btn').style.display = 'block';
    }
    ...
    document.getElementById('guilherme-btn').addEventListener('click', function () {
        fetchHours('Guilherme');
    });
...
function generateHourButtons(person, unavailableHours) {
    ...
    const hours = ['09:00:00', '09:30:00', '10:00:00', '10:30:00', '11:00:00', '13:30:00', '14:00:00', '14:30:00', '15:00:00', '15:30:00', '16:00:00', '16:30:00', '17:00:00', '17:30:00', '18:00:00', '18:30:00', '19:00:00'];
    ...
    // Verifica se é sexta (5) ou sábado (6)
    ...
    <div class="container imagem-adicional">
        <img src="assets/planos.png" alt="Imagem Adicional">
    </div>
